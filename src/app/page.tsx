      ...
      <div className="grid grid-cols-2 gap-2 md:grid-cols-3 md:gap-12 my-20 lg:my-32">
        {dogs.map(({ name, transform }, idx) => {
          return (
            <div
              key={name}
              className={`border-2 border-opacity-50 border-indigo-400 rounded-xl px-5 pt-1 pb-5 m-auto shadow-xl backdrop-blur-sm bg-white/30 shadow-purple-300 ${transform} hover:bg-purple-200 hover:scale-105 hover:transition hover:duration-500`}
            >
              <div className="my-3">
